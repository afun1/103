...
module.exports = (req, res) => {
  try {
    ...
    if (!html) {
      // If we can't find the file, return a basic HTML page
      html = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Screen Recorder - Loading...</title>
</head>
<body>
    <h1>🎬 Screen Recorder Loading...</h1>
    <p>If this page doesn't load properly, please check the deployment.</p>
    <script>
        // Try to redirect to the static file
        setTimeout(() => {
    ...
    console.log('Serving HTML from:', filePath || 'fallback');
